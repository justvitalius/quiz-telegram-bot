              ...
              updateUser(user)
                .then(updatedUser => {
                  ...
                  if (score == SIMPLE_PRIZE_SCORE && isCorrect) {
                    scoreMsg +=
                      "\n\nВы набрали балл, достаточный для получения первого подарка. Теперь вы можете обратиться к сотрудникам Сбертеха на стенде.\nПродолжайте играть и вы сможете получить еще более крутые призы!";
                  }
